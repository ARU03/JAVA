...
public class UltraFastMathametician {
    public static StringBuilder solve(StringBuilder a, StringBuilder b) {
        ...
        // Creating a new StringBuilder Object to Store the result
    ...
    public static void main(String[] args) {
        ...
        // First Binary String Input
        System.out.print("Enter Your First Input Here :: ");
        String A = scn.nextLine();

        // Second Binary String Input
        System.out.print("Enter Your Second Input Here :: ");
        String B = scn.nextLine();

        // Convert String A and B to StringBuilder Object
